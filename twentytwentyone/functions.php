...
function createjson_product_thumbnail() {
...
function personalize_product()
{

    if (is_product()) {


        wp_enqueue_script('personalize_product', get_template_directory_uri() . '/assets/js/personalize_product.js');


    }
}
add_action('wp_enqueue_scripts', 'personalize_product');
